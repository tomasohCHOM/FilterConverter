...
var Solver = /** @class */ (function () {
    ...
    Solver.prototype.css = function (filters) {
        ...
        return "filter: invert(".concat(fmt(0), "%) sepia(").concat(fmt(1), "%) saturate(").concat(fmt(2), "%) \n                hue-rotate(").concat(fmt(3, 3.6), "deg) brightness(").concat(fmt(4), "%) contrast(").concat(fmt(5), "%);");
    };
    return Solver;
}());
...
var performConvertion = document.querySelector(".perform-convertion");
var target = document.querySelector(".target");
performConvertion.addEventListener("click", function () {
    ...
    document.querySelector("lossDetail").innerHTML = "Loss: ".concat(result.loss.toFixed(1), ". <b>").concat(lossMessage, "</b>");
});
